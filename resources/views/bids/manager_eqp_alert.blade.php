...
<!--Hidden Cart view-->
		...
		<div class="container w-75 m-auto" style="box-shadow: 3px 3px 7px 7px grey; background: #fbfbfb;width:75%; margin:auto; text-align:center">
		 ...
		 <h2 style="text-align: left;color: black;font-family: sans-serif;">  
			...
			The Process of <b>{{$investor_name}}</b> & Business: <b>{{$b_name}}</b> has begun, the contact information of the parties involved is below, Thank you!
 
		           <p>The Business Owner - (Name: <b>{{$b_owner_name}}</b>, Contact: <b>{{$contact2}}</b>)</p>
		           <p style="padding-bottom:0px;padding-top:0px;">The Investor - (Name: <b>{{$investor_name}}</b>, Contact: <b>{{$contact}}</b>)</p>
